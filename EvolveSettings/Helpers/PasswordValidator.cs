...
namespace EvolveSettings.Helpers
{
    ...
    internal class PasswordValidator
    {
        ...
        {
            IEnumerable<string> lines = File.ReadLines("passdatabase.db");
        ...
        public bool checkPasswordScore(ref string message)
        {
            int passwordScore = 0;
            ...
            if (passwordScore < 50)
            {
                message = "Password found in the common database list. Probably easy to crack.";
                return false;
            }
